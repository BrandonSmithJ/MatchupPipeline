...
class ModisProcessor():
    ...
    def run_modis_geo(self, out_file=''):
        ...
        """
        geo_cmd = os.path.join(self.ocssw_root, 'bin', 'modis_GEO') \
                               + ' ' + self.l1a
        if out_file != '':
            geo_cmd += ' -o ' + out_file
    ...
    def run_modis_l1a(self, out_file=''):
        ...
        """
        l1a_cmd = os.path.join(self.ocssw_root, 'bin', 'modis_L1A')
        l1a_cmd +=  ' -v '
    ...
    def run_modis_l1b(self):
        ...
        """
        l1b_cmd = os.path.join(self.ocssw_root, 'bin', 'modis_L1B') \
                  + ' ' + self.l1a
