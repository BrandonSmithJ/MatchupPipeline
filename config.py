...
datasets = ['OLI_test_image_san_fran'] #MSI_test_image_20201017 # OLI_test_image_san_fran # 'MOD_VI_test_image' #MERIS_test_image #'Chesapeake_Bay_2016_2023'] #Erie_2021 #SaltonSea_2022 #SaltonSea_10_09_2022 #SaltonSea_shifted SaltonSea_1999_2022 GSL_02_13_2019 #GSL_High_quality
sensors  = ['OLI'] # 'MOD','VI'
...
if  'OLI_test_image' in datasets[0]  or 'MSI_test_image' in datasets[0] : 
    overwrite              = False
    ac_methods             = ['aquaverse'] # 'l2gen','acolite','polymer'  #,'l2gen','acolite','mdn-ac','polymer' #'mdn-ac',
    timeseries_or_matchups = 'timeseries'
    remove_scene_folder    = False 
    remove_L1_tile         = False
    fix_projection_Rrs     = False
    ...
    scene_id               = 'T18SUG' if 'MSI' in sensors[0] else '044033' if 'OLI' in sensors[0] else ''
